...
try {
    ...
    var head = fs.readFileSync(process.cwd() + '/node_modules/mocha-html-reporter/docs/head.html', 'utf8');
    var tail = fs.readFileSync(process.cwd() + '/node_modules/mocha-html-reporter/docs/tail.html', 'utf8');
} catch(e) {
...
function HTML(runner) {
  ...
  runner.on('end', function(){
    console.log(head + '<ul id="stats"><li class="progress"><canvas width="40" height="40"></canvas></li><li class="passes">passes: <em>%s</em></li><li class="failures">failures: <em>%s</em></li><li class="duration">duration: <em>%s</em>s</li></ul>', stats.passes, stats.failures, (stats.end - stats.start) / 1000);
	console.log('<ul id="report">' + result + '<ul>' + tail);
  });
